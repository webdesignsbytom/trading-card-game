...
function RegisterPage() {
  return (
    <>
      ...
      {/* Page */}
      <div className='main__bg h-screen grid'>
        <section className='grid h-full bg-secondary-colour main__bg lg:overflow-hidden grid-rows-reg lg:grid-rows-none lg:grid-cols-reg'>
          <Navbar />

          <main className='grid main__bg h-full items-center justify-center px-2'>
            <section className='grid bg-white rounded p-4 shadow-lg'>
