      ...
      <section className='text-sm grid gap-1'>
        ...
        <div>
          <div className='grid grid-flow-col justify-between'>
            ...
            <div>
              <span className='text-xs'>{cardData.policyCard.name}</span>
            </div>
          </div>
          <div className='grid grid-cols-rev w-full'>
            <input
        ...
        <div>
          <div className='grid grid-flow-col justify-between'>
            ...
            <div>
              <span className='text-xs'>{cardData.policyCard.cardStat}</span>
            </div>
          </div>
          <div className='grid w-full'>
            <input
        ...
        <div>
          <div className='grid grid-flow-col justify-between'>
            ...
            <div>
              <span className='text-xs'>
                {cardData.policyCard.statMultiplier}
              </span>
            </div>
          </div>
          <div className='grid w-full'>
