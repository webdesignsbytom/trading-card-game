...
function OpenRequestsListComponent() {
  ...
  return (
    <section className={`grid grid-cols-1 grid-rows-1 px-4 mb-4`}>
      {/* LEFT */}
      <section className='bg-red-400 w-full grid main__bg outline outline-4 outline-black rounded-xl p-2'>
        <div className='p-4 grid h-full grid-rows-reg'>
          ...
          <section className='grid h-full overflow-hidden overflow-y-scroll bg-green-500'>
            <table className='border-2 border-solid border-black grid grid-rows-reg'>
              <thead className='bg-slate-400 h-fit border-b-2 border-solid border-black'>
                <tr className='w-full'>
                  <th className='w-44 border-r-2 px-1 border-solid border-black'>
                    Username
                  </th>
                  <th className='w-44 border-r-2 px-1 border-solid border-black'>
                    Your Offer
